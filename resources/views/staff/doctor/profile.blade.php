        ...
        <div class="card mb-4">
            <div class="card-body p-4">
                ...
                <div x-show="!isEditing" class="row g-4">
                    ...
                    <hr>
                    <div class="col-md-6"><strong>Specialty</strong><p>{{ $user->specialty ?? 'N/A' }}</p></div>
                    <div class="col-md-6"><strong>License Number</strong><p>{{ $user->license_number ?? 'N/A' }}</p></div>
                    <div class="col-md-6"><strong>Years of Experience</strong><p>{{ $user->experience_years ?? 'N/A' }}</p></div>
                </div>
                ...
                <form x-show="isEditing" x-cloak method="post" action="{{ route('doctor.profile.update') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><label class="form-label">Phone Number</label><input type="text" name="phone_number" class="form-control" value="{{ old('phone_number', $user->phone_number) }}" required></div>
                        <div class="col-md-6"><label class="form-label">Date of Birth</label><input type="date" name="date_of_birth" class="form-control" value="{{ old('date_of_birth', $user->date_of_birth) }}" required></div>
                        ...
                        <div class="col-12"><label class="form-label">Address</label><input type="text" name="address" class="form-control" value="{{ old('address', $user->address) }}" required></div>
                        <hr>
                        <div class="col-md-6"><label class="form-label">Specialty</label><input type="text" name="specialty" class="form-control" value="{{ old('specialty', $user->specialty) }}" required></div>
                        <div class="col-md-6"><label class="form-label">License Number</label><input type="text" name="license_number" class="form-control" value="{{ old('license_number', $user->license_number) }}" required></div>
                        <div class="col-md-6"><label class="form-label">Years of Experience</label><input type="number" name="experience_years" class="form-control" value="{{ old('experience_years', $user->experience_years) }}" required></div>
                    </div>
                    <div class="mt-4">
        ...
        <div x-show="isEditing" x-cloak x-transition>
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <form method="post" action="{{ route('doctor.password.update') }}" class="mt-4">
                        @csrf
                        @method('put')
                        <div class="mb-3">
